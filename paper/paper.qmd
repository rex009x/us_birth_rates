...
```{r graph2a, fig.cap="Trends in Birth Rates by Five-year Age Group", echo=FALSE}
#| echo: false
#| message: false
#| warning: false
#| label: fig-2
...
```{r graph2b, fig.cap="Trends in Birth Rates by Mother's Level of Education (ages 20-44)", echo=FALSE}
...
fig_2d_data_long %>% ggplot(aes(x = year, y = Birth_Rate, color = Education_Level)) +
  ...
  theme(legend.position = "none")
```
```{r graph2c, fig.cap="Trends in Birth Rates by Parity (ages 15-44)", echo=FALSE}
